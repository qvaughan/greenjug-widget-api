**Below are the notes I used for live coding. You can download the slides from <https://github.com/qvaughan/greenjug-widget-api/blob/master/Lets_Play_Slides.pdf>**
